...
Namespace Unbound
	...
	Partial Public Class Dataset1
		...
		Partial Public Class ContactDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddContactRow(ByVal Name As String, ByVal Phone As String) As ContactRow
				Dim rowContactRow As ContactRow = (CType(Me.NewRow(), ContactRow))
				Dim columnValuesArray() As Object = { Name, Phone}
		...
		Partial Public Class ContactRow
			...
			Public Property Name() As String
				Get
					Try
						Return (CStr(Me(Me.tableContact.NameColumn)))
